...
items:
  - title: Web App <i>Rhetorical Framing Explorator</i>
    ...
    resources:
      ...
      - name: ; see an older version in Yu (2023) 
  ...
  - title: Examining Behaviors of Large Language Models
    ...
    description: LLMs are powerful, but model explainability is also crucial for many use cases - what have they actually learned from the training data and why do they come to a certain decision? For text data, this is especially relevant for complex tasks such as the automated detection of non-literal meaning, e.g., sarcasm or metaphor. <br><br> My colleagues and I probe the performance of diverse black-box LLMs and compare them with white-box (explainable) models on the task of figurative language classification. Interesting facts&#58; for this probing task, we found that black-box models are not that unexplainable, whereas white-box models are sometimes not really human-interpretable. 
    resources:
      - name: Yu (2023)
